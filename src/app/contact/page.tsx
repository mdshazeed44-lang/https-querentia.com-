  ...
  return (
    <>
      ...
      <section className="relative isolate overflow-hidden bg-deep-2 text-on-deep">
        ...
        >
          <style>{`
            @keyframes cu-orbit { to { transform: rotate(360deg); } }
            .cu-spin-a { animation: cu-orbit 36s linear infinite; }
            .cu-spin-b { animation: cu-orbit 24s linear infinite reverse; }
            @media (prefers-reduced-motion: reduce) {
              .cu-spin-a, .cu-spin-b { animation: none; }
            }
          `}</style>
          <div className="relative h-[26rem] w-[26rem]">
            ...
            <div className="cu-spin-a absolute inset-0">
            ...
            <div className="cu-spin-b absolute inset-0">
